from save_pose_data import outfile_path
from save_pose_data import input_source
from save_pose_data import djangoDir
import pandas as pd
import numpy as np
import cv2, os
import scipy
...
df = pd.read_csv(djangoDir + outfile_path)

cap = cv2.VideoCapture(djangoDir+"uploads/"+input_source)
hw = 720
hasFrame, frame = cap.read()
out = cv2.VideoWriter(djangoDir+'smooth/'+input_source[:-4]+'.avi',
